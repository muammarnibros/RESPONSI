<template>
    ...
    <section
      id="profil"
      class="min-h-screen container mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 pt-8 md:pt-16 lg:pt-15 pb-16 flex flex-col md:flex-row items-center gap-6"
    >
      <div class="md:w-2/3 text-center md:text-left">
        ...
        <div class="flex justify-center md:justify-start gap-8 mb-8 w-full">
      ...
      <div class="md:w-1/2 flex justify-center animate-slide-in-right mb-10">
        <img
          src="/img/pofil.jpeg"
          alt="Foto Profil"
          class="w-48 h-48 md:w-72 md:h-72 lg:w-96 lg:h-96 rounded-full object-cover shadow-2xl border-4 border-orange-400 transition-all duration-500 hover:grayscale hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.6)]"
        />
      </div>
    </section>
</template>
