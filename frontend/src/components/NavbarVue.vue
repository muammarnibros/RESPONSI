...
<li><a href="#pendidikan" class="text-white hover:text-blue-500 transform hover:-translate-
y-0.5 transition-all duration-300">Pendidikan</a></li>

<li><a href="#skill" class="text-white hover:text-blue-500 transform hover:-translate-y-0.5
transition-all duration-300">Skill</a></li>
<li><a href="#proyek" class="text-white hover:text-blue-500 transform hover:-translate-y-0.5
transition-all duration-300">Proyek</a></li>
<li><a href="#kontak" class="text-white hover:text-blue-500 transform hover:-translate-y-0.5
