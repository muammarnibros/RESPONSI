export const educationHistory = [ { id: 1, period: '2023 - Sekarang', institution: 'Universitas Amikom Yogyakarta', major: 'S1 - Informatika' },
...
export const projects = [ { title: 'Website Pengaduan Masyarakat', image: '/img/pengaduan.png',
